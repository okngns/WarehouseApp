...
export default {
    ...
    plugins: [
        mendixResolve(
            ...
            "C:/Users/User/Mendix/20240325_Assessment_OkanGunes-main/deployment/web/cachetag.txt"
        ),
        nodePolyfills(),
        esbuild({
        ...
        generatePrecacheServiceWorker({
            deploymentDir: "C:/Users/User/Mendix/20240325_Assessment_OkanGunes-main/deployment"
        }),
        copy({
            targets: [
              { src: 'C:/Users/User/Mendix/20240325_Assessment_OkanGunes-main/deployment/web/widgets/*', dest: 'dist' },
            ]
        })
    ],
};
